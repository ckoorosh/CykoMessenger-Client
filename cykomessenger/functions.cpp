	...
	char key, sec;
		...
		if (getch() == 0xE0) {
			...
			while (1) {
				system("cls");
				printf("\nMain Menu\n\n");
				printf("1- Signin Now "); if (state == 1)puts("<-\n");
				else puts("\n");
				printf("(Not have an account?)\n2- SignUp !!! "); if (state == 2)puts("<-\n");
				sec = getch();
				if (sec  == 72) {
					if (state > 1)state--;
				}
...
void usermenu() {   /*-------------------------- USER MENU ------------------------*/
	...
	if (getch() == 0xE0) {
		...
		while (1) {
			system("cls");
			printf("\n User Menu\n\n");
			printf("1- Create Channel "); if (state == 1)puts("<-");
			else puts("");
			printf("2- Join Channel "); if (state == 2)puts("<-");
			else puts("");
			printf("3- Logout "); if (state == 3)puts("<-");
			...
			if (sec == 72) {
				...
				if (state == 1)create_channel();
				else if(state==2) join_channel();
				else logout();
			}
		}
	}
...
void chat_menu() {  /*----------------------- CHAT MENU --------------------------*/
	...
	if (getch() == 0xE0) {
		...
		while (1) {
			system("cls");
			printf("\nChat Menu\n\n");
			printf("1- Send Message "); if (state == 1)puts("<-");
			else puts("");
			printf("2- Refresh "); if (state == 2)puts("<-");
			else puts("");
			printf("3- Channel Members "); if (state == 3)puts("<-");
			else puts("");
			printf("4- Search it! "); if (state == 4)puts("<-");
			else puts("");
			printf("5- Leave Channel "); if (state == 5)puts("<-");
			...
			if (sec == 72) {
				...
				if (state == 1)send_message();
				else if (state == 2) refresh();
				else if (state == 3) channel_members();
				else if (state == 4) {
					system("cls");
					puts("1- Members\n2- Messages");
					char key, sec;
					...
					if (getch() == 0xE0) {
						...
						while (1) {
							system("cls");
							printf("1- Members "); if (state == 1)puts("<-\n");
							else puts("\n");
							printf("2- Messages "); if (state == 2)puts("<-\n");
							sec = getch();
							if (sec == 72) {
								if (state > 1)state--;
							}
